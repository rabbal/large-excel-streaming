...
public class FastReflection
{
    ...
    private readonly ConcurrentDictionary<Type, FastPropertyInfo[]> _properties = new();
    private readonly ConcurrentDictionary<Type, FastFieldInfo[]> _fields = new();
    private readonly ConcurrentDictionary<PropertyInfo, FastPropertyInfo> _propertyStore = new();
